...
export const genAvatarBackground = (
	...
	const red = getColorIndex(firstLetter) % 256;
	const green = getColorIndex(secondLetter) % 256;
	const blue = Math.round(((alphaPosition(firstLetter) + alphaPosition(secondLetter)) / 2) * 11) % 256;
