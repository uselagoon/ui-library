...
function we({ userInfo: h, appInfo: m, currentPath: i, sidenavItems: a, signOutFn: y, ...B }) {
  const C = le(), { name: F, image: S, email: p } = h, O = !!S, N = F?.split(" ") ?? [], u = N[0] ?? void 0, f = N.length > 1 ? N.slice(1).join(" ") : " ", x = !!(u && f), k = x ? z(u.charAt(0), f.charAt(0)) : z(p.charAt(0), p.charAt(1)), U = x ? u.charAt(0).toUpperCase() + f.charAt(0).toUpperCase() : p.charAt(0).toUpperCase(), j = O ? /* @__PURE__ */ l(I, { children: [
    ...
    const s = /* @__PURE__ */ new Set(), r = (t) => {
      const o = i === t.url || i.startsWith(t.url + "/"), c = t.children?.some(r) ?? !1;
      return (o || c) && s.add(t.url), o || c;
    };
    return a.forEach((t) => {
      t.sectionItems.forEach(r);
    }), s;
  }, [a, i]), { state: G } = H(), [g, A] = P(!1), L = {
    ...m,
    signOutFn: y,
    isCollapsed: G === "collapsed"
  };
  return /* @__PURE__ */ l(_, { children: [
    !g && /* @__PURE__ */ e("div", { className: "lg:hidden fixed top-2 left-4 z-40", children: /* @__PURE__ */ e(M, { variant: "ghost", size: "icon", onClick: () => A(!0), "aria-label": "Open sidebar", children: /* @__PURE__ */ e(se, { className: "h-5 w-5" }) }) }),
    /* @__PURE__ */ l(
      X,
      {
        variant: "sidebar",
        ...
        children: [
          g && /* @__PURE__ */ e("div", { className: "lg:hidden absolute top-4 right-0", children: /* @__PURE__ */ e(M, { variant: "ghost", size: "icon", onClick: () => A(!1), "aria-label": "Close sidebar", children: /* @__PURE__ */ e(oe, { className: "h-5 w-5" }) }) }),
          ...
          /* @__PURE__ */ e(J, { children: a.map((s) => /* @__PURE__ */ l(K, { children: [
            ...
            /* @__PURE__ */ e(R, { className: "list-none", children: s.sectionItems.map((r) => {
              const t = r.target === "blank", o = r?.onClick, c = Array.from(b).some((n) => n.startsWith(r.url)), T = ["Projects", "Organizations"].includes(r.title);
              return /* @__PURE__ */ e(W, { children: /* @__PURE__ */ l(ne, { open: c, children: [
                ...
                /* @__PURE__ */ e(ie, { children: /* @__PURE__ */ e(V, { children: r.children?.map((n) => /* @__PURE__ */ l(d, { children: [
                  /* @__PURE__ */ e(v, { asChild: !0, isActive: b.has(n.url), children: /* @__PURE__ */ e(C, { href: n.url, className: "mt-2", children: /* @__PURE__ */ l("div", { className: "flex items-center gap-2", children: [
    ...
    g && /* @__PURE__ */ e("div", { className: "fixed inset-0 bg-black/40 z-30 lg:hidden", onClick: () => A(!1) })
  ] });
}
export {
  we as default
