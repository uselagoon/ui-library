...
import se from "./index.es98.js";
import oe from "./index.es99.js";
const z = (s, o, t) => o.children?.length ? /* @__PURE__ */ e("ul", { className: "ml-4 mt-2 space-y-1", children: o.children.map((r) => {
...
function we({ userInfo: s, appInfo: o, currentPath: t, sidenavItems: r, signOutFn: A, ...u }) {
  const f = I(), { name: F, image: S, email: c } = s, y = !!S, b = F?.split(" ") ?? [], d = b[0] ?? void 0, h = b.length > 1 ? b.slice(1).join(" ") : " ", g = !!(d && h), x = g ? $(d.charAt(0), h.charAt(0)) : $(c.charAt(0), c.charAt(1)), B = g ? d.charAt(0).toUpperCase() + h.charAt(0).toUpperCase() : c.charAt(0).toUpperCase(), O = y ? /* @__PURE__ */ n(R, { children: [
    /* @__PURE__ */ e(V, { src: S, alt: "user_avatar" }),
    /* @__PURE__ */ e(Y, { children: "Avatar" })
  ] }) : /* @__PURE__ */ e(Z, { bgColor: x.bgColor, textColor: x.textColor, children: B }), U = g ? /* @__PURE__ */ e("span", { className: "user-name", children: `${d} ${h}` }) : /* @__PURE__ */ e("span", { className: "user-name", children: c }), i = se(r, t), [m, v] = T(!1), j = {
    ...o,
    signOutFn: A,
    avatar: O,
    userDisplayName: U
    ...
    /* @__PURE__ */ n(
      D,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ e(oe, {}),
          /* @__PURE__ */ e(E, { children: r.map((C) => /* @__PURE__ */ n(W, { children: [
          ...
          /* @__PURE__ */ e(J, { children: /* @__PURE__ */ e(K, { children: /* @__PURE__ */ e(p, { children: /* @__PURE__ */ e(Q, { ...j }) }) }) })
        ]
      }
    ),
