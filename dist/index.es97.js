...
import { ChevronsUpDown as d, LifeBuoy as m, UserRoundCog as u, LogOut as h } from "lucide-react";
import { DropdownMenu as f, DropdownMenuTrigger as p, DropdownMenuContent as g, DropdownMenuItem as r } from "./index.es24.js";
import { SidebarMenuButton as w } from "./index.es41.js";
import { useLinkComponent as N } from "./index.es5.js";
function U({ email: a, kcUrl: s, signOutFn: t, avatar: l, userDisplayName: i }) {
  const o = N();
  return /* @__PURE__ */ n(f, { modal: !1, children: [
    ...
    /* @__PURE__ */ n(g, { className: "w-56", align: "start", side: "top", sideOffset: 4, children: [
      ...
      /* @__PURE__ */ e(r, { asChild: !0, children: /* @__PURE__ */ n(o, { href: `${s}/account`, target: "_blank", children: [
