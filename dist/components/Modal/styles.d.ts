...
export declare const StyledModal: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").Substitute<import("antd").ModalProps, {
    $width?: string | number | undefined;
}>> & Omit<import("react").FC<import("antd").ModalProps> & import("antd/es/modal/confirm").ModalStaticFunctions & {
