...
function A({ email: a, kcUrl: o, signOutFn: l, avatar: s, userDisplayName: c, documentationUrl: i = "https://docs.lagoon.sh/", disableAccountLink: m = !1 }) {
  const t = M();
  return /* @__PURE__ */ r(N, { modal: !1, children: [
    ...
    /* @__PURE__ */ r(x, { className: "w-56", align: "start", side: "top", sideOffset: 4, children: [
      ...
      !m && /* @__PURE__ */ e(n, { asChild: !0, children: /* @__PURE__ */ r(t, { href: `${o}/account`, target: "_blank", className: "cursor-pointer", children: [
