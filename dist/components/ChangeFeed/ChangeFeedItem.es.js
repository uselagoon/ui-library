...
function y({ date: o, id: l, tags: r, description: t, title: n }) {
  const d = f(() => !r || r.length === 0 ? null : r.map((m) => /* @__PURE__ */ e(c, { className: "mr-2", children: m }, m)), [r]);
  return /* @__PURE__ */ a("div", { className: "flex", children: [
    ...
    /* @__PURE__ */ a("div", { className: "mb-4", children: [
      /* @__PURE__ */ e("p", { className: "text-gray-500 dark:text-gray-200 text-xs font-semibold", children: o }),
